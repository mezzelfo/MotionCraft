...
class GlassFlow(BaseFlow):
    def __init__(self, N) -> None:
        ...
        self.pos_prompt = "wine falling on a empty glass"
    ...
    def get_default_image(self) -> torch.Tensor:
        image = Image.open(f"{self.this_path}/data/glass/glass.png")
        return image
    ...
    def load_flow(self):
        flow = np.load(f"{self.this_path}/data/glass/phisimu_particleflow_wine_6.npy")
        ...
        position = np.load(f"{self.this_path}/data/glass/phisimu_particleposition_wine_6.npy")
